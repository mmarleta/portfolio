    ...
    <section class="py-16 border-t border-gray-800">
      <div class="container mx-auto px-6">
        <h2 class="text-3xl font-bold mb-8 text-red-400">
          {{ $t('cases.whatsapp.problem.title') }}
        </h2>
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div class="bg-red-950/20 rounded-xl p-6 border border-red-900/30">
            <h3 class="text-xl font-bold mb-4 text-red-400">
              {{ $t('cases.whatsapp.problem.naturalBehavior') }}
            </h3>
            ...
            <div class="bg-gray-900 rounded-lg p-4 mb-4">
              <div class="space-y-2 text-sm text-gray-300 font-mono">
                ...
                <div class="flex gap-2">
                  <span class="text-gray-500">[14:32:03]</span> "tudo bem?"
                </div>
                <div class="flex gap-2">
                  <span class="text-gray-500">[14:32:07]</span> "queria agendar"
                </div>
                <div class="flex gap-2">
                  <span class="text-gray-500">[14:32:12]</span> "uma consulta"
                </div>
                <div class="flex gap-2">
                  <span class="text-gray-500">[14:32:15]</span> "pra amanhã às 10h"
                </div>
              </div>
            </div>
            ...
            <p class="text-gray-400 text-sm mb-4">
              ...
              <strong class="text-red-300">{{
                $t('cases.whatsapp.problem.normalBehavior')
              }}</strong>
              {{ $t('cases.whatsapp.problem.inWhatsApp') }}
            </p>

            <h4 class="text-red-300 font-bold mb-2">
              {{ $t('cases.whatsapp.problem.withoutAggregation') }}
            </h4>
          ...
          <div class="bg-green-950/20 rounded-xl p-6 border border-green-900/30">
            <h3 class="text-xl font-bold mb-4 text-green-400">
              {{ $t('cases.whatsapp.solution.title') }}
            </h3>

            <div class="bg-gray-900 rounded-lg p-4 mb-4">
              <div class="space-y-2 text-sm text-gray-300 font-mono">
                <div class="text-gray-500">
                  {{ $t('cases.whatsapp.solution.messagesReceived') }}
                </div>
            ...
            <p class="text-gray-400 text-sm mb-4">
              ...
              <strong class="text-green-300">{{
                $t('cases.whatsapp.solution.extendsTimeout')
              }}</strong
              >.
            </p>

            <h4 class="text-green-300 font-bold mb-2">
              {{ $t('cases.whatsapp.solution.withAggregation') }}
            </h4>
            <ul class="space-y-2 text-gray-400 text-sm">
              <li class="flex items-start gap-2">
        ...
        <div class="bg-gray-900/50 rounded-xl p-8 border border-gray-800">
          <h3 class="text-xl font-bold mb-6 text-green-400">
            {{ $t('cases.whatsapp.aggregatorFlow.title') }}
          </h3>

          <pre
            class="text-sm text-green-400 overflow-x-auto"
          ><code>┌─────────────────────────────────────────────────────────────────────────┐
      ...
      <div class="container mx-auto px-6">
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-12">
          <div>
            <p class="text-gray-400 mb-6">
              ...
              <strong class="text-green-400">{{
                $t('cases.whatsapp.typingDetection.extendIntelligently')
              }}</strong
              >.
            </p>

            <div class="bg-gray-900 rounded-xl p-6 border border-gray-800 mb-6">
              <h4 class="text-green-400 font-bold mb-4">
                {{ $t('cases.whatsapp.typingDetection.realScenario') }}
              </h4>
            ...
            <div class="bg-green-950/20 rounded-lg p-4 border border-green-900/30">
              <p class="text-green-400 text-sm">
                <strong>{{ $t('cases.whatsapp.typingDetection.result') }}</strong>
                {{ $t('cases.whatsapp.typingDetection.resultDesc') }}
              </p>
            </div>
          </div>
          ...
          <div class="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
            <h4 class="text-green-400 font-bold mb-4">
              {{ $t('cases.whatsapp.typingDetection.safetyLimits') }}
            </h4>

            <div class="space-y-4">
              <div class="flex justify-between items-center p-3 bg-gray-900 rounded-lg">
                <span class="text-gray-400">{{
                  $t('cases.whatsapp.typingDetection.maxTimeout')
                }}</span>
                <span class="text-green-400 font-mono">30 seconds</span>
              </div>
              <div class="flex justify-between items-center p-3 bg-gray-900 rounded-lg">
                <span class="text-gray-400">{{
                  $t('cases.whatsapp.typingDetection.maxMessages')
                }}</span>
                <span class="text-green-400 font-mono">10 messages</span>
              </div>
              <div class="flex justify-between items-center p-3 bg-gray-900 rounded-lg">
                <span class="text-gray-400">{{
                  $t('cases.whatsapp.typingDetection.debounceBase')
                }}</span>
    ...
    <section class="py-16 border-t border-gray-800">
      <div class="container mx-auto px-6">
        ...
        <p class="text-gray-400 mb-8 max-w-3xl">
          ...
          <strong class="text-green-400">{{
            $t('cases.whatsapp.redisIsolated.highWebhookTraffic')
          }}</strong>
        ...
        <div class="grid md:grid-cols-3 gap-6">
          <div class="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
            ...
            <h3 class="text-lg font-bold mb-3 text-green-400">
              {{ $t('cases.whatsapp.redisIsolated.faultIsolationTitle') }}
            </h3>
          ...
          <div class="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
            <div class="text-3xl mb-4">
              {{ $t('cases.whatsapp.redisIsolated.separateMetrics') }}
            </div>
            <h3 class="text-lg font-bold mb-3 text-green-400">
              {{ $t('cases.whatsapp.redisIsolated.separateMetricsTitle') }}
            </h3>
            <p class="text-gray-400 text-sm">
          ...
          <div class="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
            <div class="text-3xl mb-4">
              {{ $t('cases.whatsapp.redisIsolated.independentScale') }}
            </div>
            <h3 class="text-lg font-bold mb-3 text-green-400">
              {{ $t('cases.whatsapp.redisIsolated.independentScaleTitle') }}
            </h3>
            <p class="text-gray-400 text-sm">
    ...
    <section class="py-16 border-t border-gray-800 bg-gray-900/30">
      <div class="container mx-auto px-6">
        <h2 class="text-3xl font-bold mb-8">
          {{ $t('cases.whatsapp.gracefulDegradation.title') }}
        </h2>

        <p class="text-gray-400 mb-8 max-w-3xl">
          {{ $t('cases.whatsapp.gracefulDegradation.description') }}
          <strong class="text-green-400">{{
            $t('cases.whatsapp.gracefulDegradation.degradesNonEssential')
          }}</strong>
        ...
        <div class="grid md:grid-cols-3 gap-6 mb-12">
          <div class="bg-green-950/20 rounded-xl p-6 border border-green-900/30">
            <div class="text-green-400 font-bold text-sm mb-2">
              {{ $t('cases.whatsapp.gracefulDegradation.normal') }}
            </div>
            <h3 class="text-lg font-bold mb-3 text-white">
              {{ $t('cases.whatsapp.gracefulDegradation.normalUsers') }}
            </h3>
            <ul class="space-y-2 text-gray-400 text-sm">
          ...
          <div class="bg-yellow-950/20 rounded-xl p-6 border border-yellow-900/30">
            <div class="text-yellow-400 font-bold text-sm mb-2">
              {{ $t('cases.whatsapp.gracefulDegradation.degradedLow') }}
            </div>
            <h3 class="text-lg font-bold mb-3 text-white">
              {{ $t('cases.whatsapp.gracefulDegradation.degradedLowUsers') }}
            </h3>
            <ul class="space-y-2 text-gray-400 text-sm">
          ...
          <div class="bg-red-950/20 rounded-xl p-6 border border-red-900/30">
            <div class="text-red-400 font-bold text-sm mb-2">
              {{ $t('cases.whatsapp.gracefulDegradation.degradedHigh') }}
            </div>
            <h3 class="text-lg font-bold mb-3 text-white">
              {{ $t('cases.whatsapp.gracefulDegradation.degradedHighUsers') }}
            </h3>
            <ul class="space-y-2 text-gray-400 text-sm">
        ...
        <div class="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
          <h4 class="text-green-400 font-bold mb-4">
            {{ $t('cases.whatsapp.gracefulDegradation.configurableThresholds') }}
          </h4>
    ...
    <section class="py-16 border-t border-gray-800">
      <div class="container mx-auto px-6">
        ...
        <p class="text-gray-400 mb-8 max-w-3xl">
          ...
          <strong class="text-green-400">{{
            $t('cases.whatsapp.deterministicId.alwaysCalculates')
          }}</strong>
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-12">
          <div class="bg-gray-900/50 rounded-xl p-6 border border-gray-800">
            <h3 class="text-lg font-bold mb-4 text-green-400">
              {{ $t('cases.whatsapp.deterministicId.deterministicCalc') }}
            </h3>
...
# {{ $t('cases.whatsapp.deterministicId.ignoresHeaders') }}</code></pre>
            ...
            <p class="text-gray-400 text-sm">
              ...
              <strong class="text-red-400">{{
                $t('cases.whatsapp.deterministicId.ignored')
              }}</strong
              >{{ $t('cases.whatsapp.deterministicId.preventsHijack') }}
            </p>
          </div>

          <div class="bg-gray-900/50 rounded-xl p-6 border border-gray-800">
            <h3 class="text-lg font-bold mb-4 text-green-400">
              {{ $t('cases.whatsapp.deterministicId.phoneNormalization') }}
            </h3>
            <div class="bg-gray-800 rounded-lg p-4 mb-4">
              <pre
                class="text-sm text-gray-300 overflow-x-auto"
              ><code>{{ $t('cases.whatsapp.deterministicId.allBecomeSameUuid') }}
...
{{ $t('cases.whatsapp.deterministicId.ensureNumeric') }}</code></pre>
    ...
    <section class="py-16 border-t border-gray-800 bg-gray-900/30">
      <div class="container mx-auto px-6">
        <h2 class="text-3xl font-bold mb-8">
          {{ $t('cases.whatsapp.handoverIntegration.title') }}
        </h2>

        <p class="text-gray-400 mb-8 max-w-3xl">
          {{ $t('cases.whatsapp.handoverIntegration.description') }}
          <strong class="text-green-400">{{
            $t('cases.whatsapp.handoverIntegration.supportRealtime')
          }}</strong
          >.
        </p>
        ...
        <div class="grid md:grid-cols-2 gap-8">
          <div class="bg-gray-900/50 rounded-xl p-6 border border-gray-800">
            <h3 class="text-lg font-bold mb-4 text-green-400">
              {{ $t('cases.whatsapp.handoverIntegration.duringHandover') }}
            </h3>
            <ul class="space-y-3">
              <li class="flex items-start gap-3">
                <span class="text-green-400 text-xl">{{
                  $t('cases.whatsapp.handoverIntegration.aggregationPaused')
                }}</span>
                <div>
                  <div class="font-bold text-white">
                    {{ $t('cases.whatsapp.handoverIntegration.aggregationPausedTitle') }}
                  </div>
                  <div class="text-gray-400 text-sm">
              ...
              <li class="flex items-start gap-3">
                <span class="text-green-400 text-xl">{{
                  $t('cases.whatsapp.handoverIntegration.immediateDelivery')
                }}</span>
                <div>
                  <div class="font-bold text-white">
                    {{ $t('cases.whatsapp.handoverIntegration.immediateDeliveryTitle') }}
                  </div>
                  <div class="text-gray-400 text-sm">
              ...
              <li class="flex items-start gap-3">
                <span class="text-green-400 text-xl">{{
                  $t('cases.whatsapp.handoverIntegration.websocketRealtime')
                }}</span>
                <div>
                  <div class="font-bold text-white">
                    {{ $t('cases.whatsapp.handoverIntegration.websocketRealtimeTitle') }}
                  </div>
                  <div class="text-gray-400 text-sm">
          ...
          <div class="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
            <h4 class="text-green-400 font-bold mb-4">
              {{ $t('cases.whatsapp.handoverIntegration.handoverConfig') }}
            </h4>
            <div class="space-y-3">
              <div class="flex justify-between items-center p-3 bg-gray-900 rounded-lg">
    ...
    <section class="py-16 border-t border-gray-800">
      <div class="container mx-auto px-6">
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-12">
          <div class="bg-gray-900/50 rounded-xl p-6 border border-gray-800">
            <h3 class="text-lg font-bold mb-4 text-green-400">
              {{ $t('cases.whatsapp.evolutionApi.multiTenantInstances') }}
            </h3>
            <p class="text-gray-400 text-sm mb-4">
            ...
            <div class="bg-gray-800 rounded-lg p-4">
              ...
              ><code>{{ $t('cases.whatsapp.evolutionApi.instanceMapping') }}
{
  "clinica_sp": "Local - SP",
  "clinica_rj": "Local - RJ",
...
// GET instance:tenant:{instance_name}</code></pre>
          ...
          <div class="bg-gray-900/50 rounded-xl p-6 border border-gray-800">
            <h3 class="text-lg font-bold mb-4 text-green-400">
              {{ $t('cases.whatsapp.evolutionApi.webhookSecurity') }}
            </h3>
            <p class="text-gray-400 text-sm mb-4">
            ...
            <div class="bg-gray-800 rounded-lg p-4">
              <pre
                class="text-sm text-gray-300"
              ><code>{{ $t('cases.whatsapp.evolutionApi.validationFlow') }}
...
{{ $t('cases.whatsapp.evolutionApi.step5') }}</code></pre>
        ...
        <div class="bg-green-950/20 rounded-xl p-8 border border-green-900/30">
          <h3 class="text-xl font-bold mb-6 text-green-400">
            {{ $t('cases.whatsapp.evolutionApi.audioSupport') }}
          </h3>
          ...
          <div class="grid md:grid-cols-3 gap-6">
            <div class="text-center">
              ...
              <div class="font-bold text-white mb-2">
                {{ $t('cases.whatsapp.evolutionApi.voiceNotesTitle') }}
              </div>
            ...
            <div class="text-center">
              ...
              <div class="font-bold text-white mb-2">
                {{ $t('cases.whatsapp.evolutionApi.audioReplyTitle') }}
              </div>
              <div class="text-sm text-gray-400">
            ...
            <div class="text-center">
              ...
              <div class="font-bold text-white mb-2">
                {{ $t('cases.whatsapp.evolutionApi.minioStorageTitle') }}
              </div>
              <div class="text-sm text-gray-400">
        ...
        <div class="grid md:grid-cols-4 gap-6 mb-12">
          <div class="bg-gray-800/50 rounded-xl p-6 text-center border border-gray-700">
            <div class="text-4xl font-bold text-green-400 mb-2">
              {{ $t('cases.whatsapp.results.aiReduction') }}
            </div>
            <div class="text-gray-400 text-sm">
              {{ $t('cases.whatsapp.results.aiReductionLabel') }}
            </div>
            <div class="text-gray-500 text-xs mt-1">
              {{ $t('cases.whatsapp.results.aiReductionDesc') }}
            </div>
          </div>
          <div class="bg-gray-800/50 rounded-xl p-6 text-center border border-gray-700">
            <div class="text-4xl font-bold text-green-400 mb-2">
              {{ $t('cases.whatsapp.results.webhookLatency') }}
            </div>
            <div class="text-gray-400 text-sm">
              {{ $t('cases.whatsapp.results.webhookLatencyLabel') }}
            </div>
            <div class="text-gray-500 text-xs mt-1">
              {{ $t('cases.whatsapp.results.webhookLatencyDesc') }}
            </div>
          </div>
          <div class="bg-gray-800/50 rounded-xl p-6 text-center border border-gray-700">
            <div class="text-4xl font-bold text-green-400 mb-2">
              {{ $t('cases.whatsapp.results.redisIsolation') }}
            </div>
            <div class="text-gray-400 text-sm">
              {{ $t('cases.whatsapp.results.redisIsolationLabel') }}
            </div>
            <div class="text-gray-500 text-xs mt-1">
              {{ $t('cases.whatsapp.results.redisIsolationDesc') }}
            </div>
          </div>
          <div class="bg-gray-800/50 rounded-xl p-6 text-center border border-gray-700">
            <div class="text-4xl font-bold text-green-400 mb-2">
              {{ $t('cases.whatsapp.results.simultaneousUsers') }}
            </div>
            <div class="text-gray-400 text-sm">
              {{ $t('cases.whatsapp.results.simultaneousUsersLabel') }}
            </div>
            <div class="text-gray-500 text-xs mt-1">
              {{ $t('cases.whatsapp.results.simultaneousUsersDesc') }}
            </div>
          </div>
        </div>
    ...
    <!-- CTA -->
    <ProjectCTA
      title-key="cases.whatsapp.cta.title"
      description-key="cases.whatsapp.cta.description"
    >
      <template #actions>
        <a
  ...
  meta: [
    {
      name: 'description',
      content:
        'Enterprise WhatsApp service with Message Aggregator (5s debounce), isolated Redis, graceful degradation and Evolution API integration.',
    },
  ],
})
</script>
