    ...
    <section class="relative py-20 overflow-hidden">
      ...
      <div class="container mx-auto px-6 relative z-10">
        <NuxtLink to="/" class="inline-flex items-center text-emerald-400 hover:text-emerald-300 mb-8 transition-colors">
          ...
          {{ $t('cases.whatsapp.backToPortfolio') }}
        </NuxtLink>
        ...
        <div class="flex items-center gap-4 mb-6">
          ...
          <span class="px-4 py-2 bg-gray-800 text-gray-300 rounded-full text-sm">
            {{ $t('cases.whatsapp.badge') }}
          </span>
        </div>
        
        <h1 class="text-5xl md:text-6xl font-bold mb-6">
          <span class="bg-gradient-to-r from-green-400 via-green-300 to-emerald-400 bg-clip-text text-transparent">
            {{ $t('cases.whatsapp.title') }}
          </span>
        </h1>
        
        <p class="text-xl text-gray-400 max-w-3xl mb-8">
          {{ $t('cases.whatsapp.description') }}
        </p>

        <div class="flex flex-wrap gap-3">
          <span class="px-3 py-1 bg-gray-800 rounded-full text-sm text-gray-300">{{ $t('cases.whatsapp.tags.aggregator') }}</span>
          <span class="px-3 py-1 bg-gray-800 rounded-full text-sm text-gray-300">{{ $t('cases.whatsapp.tags.debounce') }}</span>
          <span class="px-3 py-1 bg-gray-800 rounded-full text-sm text-gray-300">{{ $t('cases.whatsapp.tags.evolution') }}</span>
          <span class="px-3 py-1 bg-gray-800 rounded-full text-sm text-gray-300">{{ $t('cases.whatsapp.tags.redis') }}</span>
          <span class="px-3 py-1 bg-gray-800 rounded-full text-sm text-gray-300">{{ $t('cases.whatsapp.tags.degradation') }}</span>
          <span class="px-3 py-1 bg-gray-800 rounded-full text-sm text-gray-300">{{ $t('cases.whatsapp.tags.websocket') }}</span>
        </div>
      </div>
    </section>
...
{{ $t('cases.whatsapp.evolutionApi.step5') }}</code></pre>
    ...
    <section class="py-16 border-t border-gray-800">
      <div class="container mx-auto px-6 text-center">
        <h2 class="text-3xl font-bold mb-4">{{ $t('cases.whatsapp.cta.title') }}</h2>
