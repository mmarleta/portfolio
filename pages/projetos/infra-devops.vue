    ...
    <header class="border-b border-gray-800 bg-gray-950/80 backdrop-blur-sm sticky top-0 z-50">
      <div class="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
        <NuxtLink to="/" class="text-emerald-400 hover:text-emerald-300 flex items-center gap-2">
          ...
          {{ $t('cases.infraDevops.back') }}
        </NuxtLink>
        <span class="text-gray-500 text-sm">{{ $t('cases.infraDevops.platformName') }}</span>
      </div>
    </header>
      ...
      <div class="max-w-4xl mx-auto">
        <div class="flex items-center gap-3 mb-6">
          <span class="px-3 py-1 bg-cyan-500/20 text-cyan-400 rounded-full text-sm font-medium">
            {{ $t('cases.infraDevops.badge') }}
          </span>
          <span class="px-3 py-1 bg-gray-800 text-gray-400 rounded-full text-sm">
            {{ $t('cases.infraDevops.badgeSecondary') }}
          </span>
        </div>
        
        <h1 class="text-4xl md:text-5xl font-bold mb-6">
          {{ $t('cases.infraDevops.title') }}
          <span class="text-cyan-400"> {{ $t('cases.infraDevops.titleHighlight') }}</span>
        </h1>
        
        <p class="text-xl text-gray-400 mb-8 leading-relaxed">
          {{ $t('cases.infraDevops.description') }}
        </p>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4 text-center">
            ...
            <div class="text-sm text-gray-500">{{ $t('cases.infraDevops.metrics.microservices') }}</div>
          </div>
          <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4 text-center">
            <div class="text-2xl font-bold text-cyan-400">6</div>
            <div class="text-sm text-gray-500">{{ $t('cases.infraDevops.metrics.composeOverlays') }}</div>
          </div>
          <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4 text-center">
            <div class="text-2xl font-bold text-cyan-400">3</div>
            <div class="text-sm text-gray-500">{{ $t('cases.infraDevops.metrics.sentinelsHa') }}</div>
          </div>
          <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4 text-center">
            <div class="text-2xl font-bold text-cyan-400">12</div>
            <div class="text-sm text-gray-500">{{ $t('cases.infraDevops.metrics.workflowsCicd') }}</div>
          </div>
        </div>
      </div>
    </section>
    ...
    <nav class="sticky top-16 z-40 bg-gray-950/90 backdrop-blur-sm border-b border-gray-800">
      <div class="max-w-4xl mx-auto px-4">
        <div class="flex gap-6 overflow-x-auto py-4 text-sm">
          <a href="#problema" class="text-gray-400 hover:text-cyan-400 whitespace-nowrap transition-colors">{{ $t('cases.infraDevops.nav.problem') }}</a>
          <a href="#containers" class="text-gray-400 hover:text-cyan-400 whitespace-nowrap transition-colors">{{ $t('cases.infraDevops.nav.containers') }}</a>
          <a href="#scaling" class="text-gray-400 hover:text-cyan-400 whitespace-nowrap transition-colors">{{ $t('cases.infraDevops.nav.scaling') }}</a>
          <a href="#ha" class="text-gray-400 hover:text-cyan-400 whitespace-nowrap transition-colors">{{ $t('cases.infraDevops.nav.ha') }}</a>
          <a href="#cicd" class="text-gray-400 hover:text-cyan-400 whitespace-nowrap transition-colors">{{ $t('cases.infraDevops.nav.cicd') }}</a>
          <a href="#seguranca" class="text-gray-400 hover:text-cyan-400 whitespace-nowrap transition-colors">{{ $t('cases.infraDevops.nav.security') }}</a>
          <a href="#operacoes" class="text-gray-400 hover:text-cyan-400 whitespace-nowrap transition-colors">{{ $t('cases.infraDevops.nav.operations') }}</a>
          <a href="#resultados" class="text-gray-400 hover:text-cyan-400 whitespace-nowrap transition-colors">{{ $t('cases.infraDevops.nav.results') }}</a>
        </div>
      </div>
    </nav>
      ...
      <section id="problema" class="mb-16">
        ...
        <div class="prose prose-invert max-w-none">
          ...
          <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-6 my-6">
            <h4 class="text-lg font-semibold text-gray-200 mb-4">{{ $t('cases.infraDevops.problem.challengesTitle') }}</h4>
            <ul class="space-y-3 text-gray-400">
              <li class="flex items-start gap-3">
                <span class="text-red-400 mt-1">•</span>
                <span><strong class="text-gray-200">Spiky traffic:</strong> {{ $t('cases.infraDevops.problem.challenges.spikyTraffic') }}</span>
              </li>
              <li class="flex items-start gap-3">
                <span class="text-red-400 mt-1">•</span>
                <span><strong class="text-gray-200">Stateful services:</strong> {{ $t('cases.infraDevops.problem.challenges.statefulServices') }}</span>
              </li>
              <li class="flex items-start gap-3">
                <span class="text-red-400 mt-1">•</span>
                <span><strong class="text-gray-200">Redis as SPOF:</strong> {{ $t('cases.infraDevops.problem.challenges.redisSPOF') }}</span>
              </li>
              <li class="flex items-start gap-3">
                <span class="text-red-400 mt-1">•</span>
                <span><strong class="text-gray-200">12+ microservices:</strong> {{ $t('cases.infraDevops.problem.challenges.microservices') }}</span>
              </li>
              <li class="flex items-start gap-3">
                <span class="text-red-400 mt-1">•</span>
                <span><strong class="text-gray-200">Secrets sprawl:</strong> {{ $t('cases.infraDevops.problem.challenges.secretsSprawl') }}</span>
              </li>
            </ul>
          </div>
        ...
        <div class="prose prose-invert max-w-none">
          ...
          <div class="bg-gray-900 rounded-lg overflow-hidden mb-6">
            <div class="bg-gray-800 px-4 py-2 text-sm text-gray-400 font-mono flex items-center justify-between">
              ...
              <span class="text-cyan-400">{{ $t('cases.infraDevops.containers.dockerfileTitle') }}</span>
            </div>
            <pre class="p-4 overflow-x-auto text-sm"><code class="text-gray-300"># Multi-stage build with Python 3.12-slim
...
CMD ["/app/scripts/start-memory-engine.sh"]</code></pre>
          ...
          <h3 class="text-xl font-semibold text-gray-200 mt-8 mb-4">{{ $t('cases.infraDevops.containers.overlaysTitle') }}</h3>
          ...
          <div class="grid md:grid-cols-2 gap-4 my-6">
            <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
              ...
              <p class="text-sm text-gray-400">{{ $t('cases.infraDevops.containers.overlays.base') }}</p>
            </div>
            <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
              <h4 class="font-semibold text-cyan-400 mb-2">docker-compose.scale.yml</h4>
              <p class="text-sm text-gray-400">{{ $t('cases.infraDevops.containers.overlays.scale') }}</p>
            </div>
            <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
              <h4 class="font-semibold text-cyan-400 mb-2">docker-compose.sentinel.yml</h4>
              <p class="text-sm text-gray-400">{{ $t('cases.infraDevops.containers.overlays.sentinel') }}</p>
            </div>
            <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
              <h4 class="font-semibold text-cyan-400 mb-2">docker-compose.dev.yml</h4>
              <p class="text-sm text-gray-400">{{ $t('cases.infraDevops.containers.overlays.dev') }}</p>
            </div>
          </div>

          <div class="bg-gray-900 rounded-lg overflow-hidden mb-6">
            <div class="bg-gray-800 px-4 py-2 text-sm text-gray-400 font-mono">{{ $t('cases.infraDevops.containers.compositionTitle') }}</div>
...
docker compose \
  ...
  up -d</code></pre>
          ...
          <!-- Resource Limits -->
          <h3 class="text-xl font-semibold text-gray-200 mt-8 mb-4">{{ $t('cases.infraDevops.containers.resourceLimitsTitle') }}</h3>
          
          <div class="bg-gray-900 rounded-lg overflow-hidden mb-6">
            <div class="bg-gray-800 px-4 py-2 text-sm text-gray-400 font-mono">docker-compose.yml - Redis with limits</div>
    ...
    - "com.optimus.environment=production"</code></pre>
      ...
      <section id="scaling" class="mb-16">
        ...
        <div class="prose prose-invert max-w-none">
          ...
          <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-6 my-6">
            <h4 class="text-lg font-semibold text-gray-200 mb-4 text-center">{{ $t('cases.infraDevops.scaling.architectureTitle') }}</h4>
            <div class="font-mono text-sm text-center">
              <div class="text-gray-500 mb-4">{{ $t('cases.infraDevops.scaling.externalTraffic') }}</div>
              ...
              <div class="text-gray-500 text-xs">{{ $t('cases.infraDevops.scaling.dynamicDns') }}</div>
            </div>
          </div>

          <h3 class="text-xl font-semibold text-gray-200 mt-8 mb-4">{{ $t('cases.infraDevops.scaling.nginxLbTitle') }}</h3>

          <div class="bg-gray-900 rounded-lg overflow-hidden mb-6">
            <div class="bg-gray-800 px-4 py-2 text-sm text-gray-400 font-mono">nginx/nginx-lb.conf</div>
            <pre class="p-4 overflow-x-auto text-sm"><code class="text-gray-300"># Docker internal DNS resolver - CRITICAL for --scale
...
map $http_upgrade $connection_upgrade {
    ...
    '' close;
          ...
          <h3 class="text-xl font-semibold text-gray-200 mt-8 mb-4">{{ $t('cases.infraDevops.scaling.migrationJobTitle') }}</h3>
          ...
          <div class="bg-gray-900 rounded-lg overflow-hidden mb-6">
            ...
            <pre class="p-4 overflow-x-auto text-sm"><code class="text-gray-300"># Single migrations job (runs once, exits)
migrations:
  extends:
  ...
  depends_on:
    migrations:
      condition: service_completed_successfully</code></pre>
          ...
          <h3 class="text-xl font-semibold text-gray-200 mt-8 mb-4">{{ $t('cases.infraDevops.scaling.scaleUpScriptTitle') }}</h3>

          <div class="bg-gray-900 rounded-lg overflow-hidden mb-6">
            <div class="bg-gray-800 px-4 py-2 text-sm text-gray-400 font-mono">scripts/scale-up.sh (options)</div>
...
./scripts/scale-up.sh --down --prune-network</code></pre>
          ...
          <div class="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4 my-6">
            <h4 class="font-semibold text-yellow-400 mb-2">⚠️ {{ $t('cases.infraDevops.scaling.statefulConsiderations.title') }}</h4>
            <p class="text-sm text-gray-300">
              {{ $t('cases.infraDevops.scaling.statefulConsiderations.description') }}
              <code class="text-yellow-400">DB_POOL_SIZE=5 DB_MAX_OVERFLOW=10</code> = max 15 connections/replica.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="ha" class="mb-16">
        ...
        <div class="prose prose-invert max-w-none">
          ...
          <!-- Sentinel Topology -->
          <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-6 my-6">
            <h4 class="text-lg font-semibold text-gray-200 mb-4 text-center">{{ $t('cases.infraDevops.ha.topologyTitle') }}</h4>
            <div class="font-mono text-sm">
              ...
              <div class="text-center text-gray-500 mb-4">{{ $t('cases.infraDevops.ha.quorum') }}</div>
              <div class="text-center text-purple-400 mb-4">↓ {{ $t('cases.infraDevops.ha.monitors') }} ↓</div>
              <div class="flex justify-center gap-6">
                <div class="text-center">
                  <div class="bg-green-500/20 border border-green-500/40 rounded-lg px-4 py-3">
                    ...
                    <span class="text-gray-500 text-xs block">:6379 {{ $t('cases.infraDevops.ha.writes') }}</span>
                  </div>
                </div>
                ...
                <div class="text-center">
                  <div class="bg-blue-500/20 border border-blue-500/40 rounded-lg px-4 py-3">
                    ...
                    <span class="text-gray-500 text-xs block">:6379 {{ $t('cases.infraDevops.ha.reads') }}</span>
                  </div>
                </div>
                <div class="text-center">
                  <div class="bg-blue-500/20 border border-blue-500/40 rounded-lg px-4 py-3">
          ...
          <div class="bg-gray-900 rounded-lg overflow-hidden mb-6">
            ...
            <pre class="p-4 overflow-x-auto text-sm"><code class="text-gray-300"># Redis Master with replication enabled
redis:
  image: redis:8.0-alpine
...
ai-engine:
  environment:
    ...
    - REDIS_SENTINEL_HOSTS=sentinel-1:26379,sentinel-2:26379,sentinel-3:26379</code></pre>
          ...
          <h3 class="text-xl font-semibold text-gray-200 mt-8 mb-4">{{ $t('cases.infraDevops.ha.failoverTitle') }}</h3>
          ...
          <div class="bg-green-500/10 border border-green-500/30 rounded-lg p-4 my-6">
            <h4 class="font-semibold text-green-400 mb-2">✓ {{ $t('cases.infraDevops.ha.whyThreeSentinels.title') }}</h4>
            <p class="text-sm text-gray-300">
      ...
      <section id="cicd" class="mb-16">
        ...
        <div class="prose prose-invert max-w-none">
          ...
          <div class="grid md:grid-cols-2 gap-4 my-6">
            <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
              <div class="flex items-center gap-2 mb-2">
                ...
                <h4 class="font-semibold text-gray-200">{{ $t('cases.infraDevops.cicd.workflows.ci.title') }}</h4>
              </div>
              <p class="text-sm text-gray-400">{{ $t('cases.infraDevops.cicd.workflows.ci.description') }}</p>
            </div>
            <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
              <div class="flex items-center gap-2 mb-2">
                <span class="w-2 h-2 bg-yellow-400 rounded-full"></span>
                <h4 class="font-semibold text-gray-200">{{ $t('cases.infraDevops.cicd.workflows.guardrails.title') }}</h4>
              </div>
              <p class="text-sm text-gray-400">{{ $t('cases.infraDevops.cicd.workflows.guardrails.description') }}</p>
            </div>
            <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
              <div class="flex items-center gap-2 mb-2">
                <span class="w-2 h-2 bg-blue-400 rounded-full"></span>
                <h4 class="font-semibold text-gray-200">{{ $t('cases.infraDevops.cicd.workflows.e2e.title') }}</h4>
              </div>
              <p class="text-sm text-gray-400">{{ $t('cases.infraDevops.cicd.workflows.e2e.description') }}</p>
            </div>
            <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
              <div class="flex items-center gap-2 mb-2">
                <span class="w-2 h-2 bg-purple-400 rounded-full"></span>
                <h4 class="font-semibold text-gray-200">{{ $t('cases.infraDevops.cicd.workflows.llmEval.title') }}</h4>
              </div>
              <p class="text-sm text-gray-400">{{ $t('cases.infraDevops.cicd.workflows.llmEval.description') }}</p>
            </div>
          </div>

          <h3 class="text-xl font-semibold text-gray-200 mt-8 mb-4">{{ $t('cases.infraDevops.cicd.guardrailsTitle') }}</h3>
          ...
          <div class="bg-gray-900 rounded-lg overflow-hidden mb-6">
            ...
            <pre v-pre class="p-4 overflow-x-auto text-sm"><code class="text-gray-300"># Runs only on PRs that touch Python code
on:
  pull_request:
    paths:
      - 'ai-engine/**/*.py'
    ...
    steps:
      ...
      - name: Comment on PR (if violations)
        ...
        with:
          ...
          <h3 class="text-xl font-semibold text-gray-200 mt-8 mb-4">{{ $t('cases.infraDevops.cicd.e2eTestsTitle') }}</h3>
      ...
      <section id="seguranca" class="mb-16">
        ...
        <div class="prose prose-invert max-w-none">
          ...
          <div class="bg-gray-900 rounded-lg overflow-hidden mb-6">
            ...
            <pre class="p-4 overflow-x-auto text-sm"><code class="text-gray-300">./secrets-manager.sh init        # Create .env.secrets from example
...
./secrets-manager.sh check-security  # Audit for issues</code></pre>
          ...
          <h3 class="text-xl font-semibold text-gray-200 mt-8 mb-4">{{ $t('cases.infraDevops.security.secretsSeparationTitle') }}</h3>
          
          <div class="grid md:grid-cols-3 gap-4 my-6">
            <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
              <h4 class="font-semibold text-red-400 mb-2">.env.secrets</h4>
              <p class="text-sm text-gray-400">{{ $t('cases.infraDevops.security.secretsFiles.secrets') }}</p>
            </div>
            <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
              <h4 class="font-semibold text-yellow-400 mb-2">.env.models</h4>
              <p class="text-sm text-gray-400">{{ $t('cases.infraDevops.security.secretsFiles.models') }}</p>
            </div>
            <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
              <h4 class="font-semibold text-green-400 mb-2">.env.example</h4>
              <p class="text-sm text-gray-400">{{ $t('cases.infraDevops.security.secretsFiles.example') }}</p>
            </div>
          </div>

          <h3 class="text-xl font-semibold text-gray-200 mt-8 mb-4">{{ $t('cases.infraDevops.security.containerSecurityTitle') }}</h3>

          <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-6 my-6">
            <ul class="space-y-3 text-gray-400">
              <li class="flex items-start gap-3">
                <span class="text-green-400 mt-1">✓</span>
                <span><strong class="text-gray-200">Non-root users:</strong> {{ $t('cases.infraDevops.security.containerSecurity.nonRoot') }}</span>
              </li>
              <li class="flex items-start gap-3">
                <span class="text-green-400 mt-1">✓</span>
                <span><strong class="text-gray-200">Slim base images:</strong> {{ $t('cases.infraDevops.security.containerSecurity.slimImages') }}</span>
              </li>
              <li class="flex items-start gap-3">
                <span class="text-green-400 mt-1">✓</span>
                <span><strong class="text-gray-200">Read-only configs:</strong> {{ $t('cases.infraDevops.security.containerSecurity.readOnlyConfigs') }}</span>
              </li>
              <li class="flex items-start gap-3">
                <span class="text-green-400 mt-1">✓</span>
                <span><strong class="text-gray-200">Network isolation:</strong> {{ $t('cases.infraDevops.security.containerSecurity.networkIsolation') }}</span>
              </li>
              <li class="flex items-start gap-3">
                <span class="text-green-400 mt-1">✓</span>
                <span><strong class="text-gray-200">Internal Memory Engine:</strong> {{ $t('cases.infraDevops.security.containerSecurity.internalEngine') }}</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <section id="operacoes" class="mb-16">
        ...
        <div class="prose prose-invert max-w-none">
          ...
          <div class="grid md:grid-cols-2 gap-4 my-6">
            <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
              <h4 class="font-semibold text-blue-400 mb-2">{{ $t('cases.infraDevops.operations.scripts.scaleUp.title') }}</h4>
              <p class="text-sm text-gray-400 mb-2">{{ $t('cases.infraDevops.operations.scripts.scaleUp.description') }}</p>
              <code class="text-xs text-gray-500">--scale, --build, --observability, --attach</code>
            </div>
            <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
              <h4 class="font-semibold text-blue-400 mb-2">{{ $t('cases.infraDevops.operations.scripts.validateRedis.title') }}</h4>
              <p class="text-sm text-gray-400 mb-2">{{ $t('cases.infraDevops.operations.scripts.validateRedis.description') }}</p>
              <code class="text-xs text-gray-500">redis-cli info, dbsize, latency</code>
            </div>
            <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
              <h4 class="font-semibold text-blue-400 mb-2">{{ $t('cases.infraDevops.operations.scripts.loadTests.title') }}</h4>
              <p class="text-sm text-gray-400 mb-2">{{ $t('cases.infraDevops.operations.scripts.loadTests.description') }}</p>
              <code class="text-xs text-gray-500">--users, --duration, --endpoint</code>
            </div>
            <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
              <h4 class="font-semibold text-blue-400 mb-2">{{ $t('cases.infraDevops.operations.scripts.traceSmokeTest.title') }}</h4>
              <p class="text-sm text-gray-400 mb-2">{{ $t('cases.infraDevops.operations.scripts.traceSmokeTest.description') }}</p>
              <code class="text-xs text-gray-500">opentelemetry, tempo, span verification</code>
            </div>
          </div>

          <h3 class="text-xl font-semibold text-gray-200 mt-8 mb-4">{{ $t('cases.infraDevops.operations.healthChecksTitle') }}</h3>
      ...
      <section id="resultados" class="mb-16">
        ...
        <div class="grid md:grid-cols-2 gap-6">
          <div class="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20 rounded-lg p-6">
            ...
            <div class="text-gray-400">{{ $t('cases.infraDevops.results.metrics.deployTime') }}</div>
          </div>
          <div class="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20 rounded-lg p-6">
          ...
          <div class="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20 rounded-lg p-6">
            ...
            <div class="text-gray-400">{{ $t('cases.infraDevops.results.metrics.secretsExposed') }}</div>
          </div>
          <div class="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20 rounded-lg p-6">
        ...
        <div class="bg-gray-900/50 border border-gray-800 rounded-lg p-6 mt-8">
          <h3 class="text-xl font-semibold text-gray-200 mb-4">{{ $t('cases.infraDevops.results.lessonsLearned.title') }}</h3>
          <ul class="space-y-3 text-gray-400">
            <li class="flex items-start gap-3">
              <span class="text-cyan-400 mt-1">→</span>
              <span><strong class="text-gray-200">{{ $t('cases.infraDevops.results.lessonsLearned.overlays') }}</strong></span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-cyan-400 mt-1">→</span>
              <span><strong class="text-gray-200">{{ $t('cases.infraDevops.results.lessonsLearned.migrations') }}</strong></span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-cyan-400 mt-1">→</span>
              <span><strong class="text-gray-200">{{ $t('cases.infraDevops.results.lessonsLearned.healthChecks') }}</strong></span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-cyan-400 mt-1">→</span>
              <span><strong class="text-gray-200">{{ $t('cases.infraDevops.results.lessonsLearned.dynamicDns') }}</strong></span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-cyan-400 mt-1">→</span>
              <span><strong class="text-gray-200">{{ $t('cases.infraDevops.results.lessonsLearned.sentinelQuorum') }}</strong></span>
            </li>
          </ul>
        </div>
      </section>
...
useHead({
  ...
  meta: [
    { name: 'description', content: t('cases.infraDevops.meta.description') }
  ]
})
</script>
