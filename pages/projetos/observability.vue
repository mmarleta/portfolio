            ...
            <li class="flex items-start gap-2">
              ...
              <span
                ><strong class="text-white">{{
                  $t('cases.observability.whyObservability.debug')
                }}</strong
                >{{ $t('cases.observability.whyObservability.debugQ') }}</span
              >
            </li>
            <li class="flex items-start gap-2">
              <span class="text-yellow-400 mt-1">?</span>
              <span
                ><strong class="text-white">{{
                  $t('cases.observability.whyObservability.performance')
                }}</strong
                >{{ $t('cases.observability.whyObservability.performanceQ') }}</span
              >
            </li>
            <li class="flex items-start gap-2">
              <span class="text-yellow-400 mt-1">?</span>
              <span
                ><strong class="text-white">{{
                  $t('cases.observability.whyObservability.costs')
                }}</strong
                >{{ $t('cases.observability.whyObservability.costsQ') }}</span
              >
            </li>
            <li class="flex items-start gap-2">
              <span class="text-yellow-400 mt-1">?</span>
              <span
                ><strong class="text-white">{{
                  $t('cases.observability.whyObservability.business')
                }}</strong
                >{{ $t('cases.observability.whyObservability.businessQ') }}</span
              >
            </li>
            <li class="flex items-start gap-2">
              <span class="text-yellow-400 mt-1">?</span>
              <span
                ><strong class="text-white">{{
                  $t('cases.observability.whyObservability.quality')
                }}</strong
                >{{ $t('cases.observability.whyObservability.qualityQ') }}</span
              >
            </li>
          </ul>
        </div>
        ...
        <div class="space-y-6">
          ...
          <div class="bg-gray-900/30 border border-gray-800 rounded-xl p-8">
            <h3 class="text-xl font-semibold text-green-400 mb-4">
              {{ $t('cases.observability.stack.businessMetrics.title') }}
            </h3>
            <p class="text-gray-300 leading-relaxed mb-4">
              ...
              <table class="w-full text-sm">
                <thead>
                  <tr class="text-left text-gray-500 border-b border-gray-800">
                    <th class="pb-2">
                      {{ $t('cases.observability.stack.businessMetrics.tableMetric') }}
                    </th>
                    <th class="pb-2">
                      {{ $t('cases.observability.stack.businessMetrics.tableOwner') }}
                    </th>
                    <th class="pb-2">
                      {{ $t('cases.observability.stack.businessMetrics.tableLabels') }}
                    </th>
                  </tr>
                </thead>
                <tbody class="text-gray-400">
                  <tr class="border-b border-gray-800/50">
                    <td class="py-2 font-mono text-xs text-green-400">
                      optimus_handover_requests_total
                    </td>
                  ...
                  <tr class="border-b border-gray-800/50">
                    <td class="py-2 font-mono text-xs text-green-400">
                      optimus_ai_conversations_total
                    </td>
                  ...
                  <tr class="border-b border-gray-800/50">
                    <td class="py-2 font-mono text-xs text-green-400">
                      optimus_booking_attempts_total
                    </td>
                  ...
                  <tr>
                    <td class="py-2 font-mono text-xs text-green-400">
                      optimus_ai_first_response_seconds
                    </td>
                    <td class="py-2">AI Engine</td>
            ...
            <p class="text-gray-500 text-sm">
              <strong class="text-gray-300">{{
                $t('cases.observability.stack.businessMetrics.ownershipNote')
              }}</strong
              >{{ $t('cases.observability.stack.businessMetrics.ownershipDesc') }}
            </p>
          </div>
          ...
          <div class="bg-gray-900/30 border border-gray-800 rounded-xl p-8">
            <h3 class="text-xl font-semibold text-green-400 mb-4">
              {{ $t('cases.observability.stack.tracing.title') }}
            </h3>
            <p class="text-gray-300 leading-relaxed mb-4">
...
{{ $t('cases.observability.stack.tracing.propagatedVia') }}
            ...
            <div class="grid md:grid-cols-2 gap-4">
              <div class="bg-gray-800/50 rounded-lg p-4">
                <div class="text-emerald-400 font-semibold mb-2">
                  {{ $t('cases.observability.stack.tracing.autoInstrumentation') }}
                </div>
              ...
              <div class="bg-gray-800/50 rounded-lg p-4">
                <div class="text-purple-400 font-semibold mb-2">
                  {{ $t('cases.observability.stack.tracing.customSpans') }}
                </div>
                <ul class="text-gray-500 text-sm space-y-1">
          ...
          <div class="bg-gray-900/30 border border-gray-800 rounded-xl p-8">
            <h3 class="text-xl font-semibold text-green-400 mb-4">
              {{ $t('cases.observability.stack.tokenUsage.title') }}
            </h3>
            <p class="text-gray-300 leading-relaxed mb-4">
...

{
  ...
  "daily_usage": {
    ...
    ...
            ...
            <p class="text-gray-500 text-sm">
              {{ $t('cases.observability.stack.tokenUsage.dataExtracted') }}
              <code class="text-emerald-400">llm.input_tokens</code>,
              <code class="text-emerald-400">llm.output_tokens</code>,
              <code class="text-emerald-400">llm.model</code>.
            </p>
          </div>
          ...
          <div class="bg-gray-900/30 border border-gray-800 rounded-xl p-8">
            <h3 class="text-xl font-semibold text-green-400 mb-4">
              {{ $t('cases.observability.stack.stateSnapshot.title') }}
            </h3>
            <p class="text-gray-300 leading-relaxed mb-4">
...
response_metadata.state_snapshot = {
  ...
  "tool_budget_max": 6
          ...
          <div class="bg-gray-900/30 border border-gray-800 rounded-xl p-8">
            <h3 class="text-xl font-semibold text-green-400 mb-4">
              {{ $t('cases.observability.stack.ragTelemetry.title') }}
            </h3>
            <p class="text-gray-300 leading-relaxed mb-4">
              ...
              <pre class="text-gray-300">
{
  ...
  "reasoning_samples": [
    {"item": "hemograma", "reason": "exact_match", "score": 0.95}
          ...
          <div class="bg-gray-900/30 border border-gray-800 rounded-xl p-8">
            <h3 class="text-xl font-semibold text-green-400 mb-4">
              {{ $t('cases.observability.stack.usageMonitoring.title') }}
            </h3>
            <p class="text-gray-300 leading-relaxed mb-4">
            ...
            <ul class="space-y-2 text-gray-400 text-sm">
              <li class="flex items-start gap-2">
                ...
                <span
                  ><strong class="text-white">{{
                    $t('cases.observability.stack.usageMonitoring.nonIntrusive')
                  }}</strong
                  >{{ $t('cases.observability.stack.usageMonitoring.nonIntrusiveDesc') }}</span
                >
              </li>
              <li class="flex items-start gap-2">
                <span class="text-emerald-400 mt-1">✓</span>
                <span
                  ><strong class="text-white">{{
                    $t('cases.observability.stack.usageMonitoring.sampleRate')
                  }}</strong
                  >{{ $t('cases.observability.stack.usageMonitoring.sampleRateDesc') }}</span
                >
              </li>
              <li class="flex items-start gap-2">
                <span class="text-emerald-400 mt-1">✓</span>
                <span
                  ><strong class="text-white">{{
                    $t('cases.observability.stack.usageMonitoring.thirtyDaysData')
                  }}</strong
                  >{{ $t('cases.observability.stack.usageMonitoring.thirtyDaysDesc') }}</span
                >
              </li>
              <li class="flex items-start gap-2">
                <span class="text-emerald-400 mt-1">✓</span>
                <span
                  ><strong class="text-white">{{
                    $t('cases.observability.stack.usageMonitoring.endpointTracking')
                  }}</strong
                  >{{ $t('cases.observability.stack.usageMonitoring.endpointTrackingDesc') }}</span
                >
              </li>
            </ul>
          </div>
          ...
          <div class="bg-gray-900/30 border border-gray-800 rounded-xl p-8">
            <h3 class="text-xl font-semibold text-green-400 mb-4">
              {{ $t('cases.observability.stack.performanceThresholds.title') }}
            </h3>
            <p class="text-gray-300 leading-relaxed mb-4">
            ...
            <div class="grid md:grid-cols-2 gap-4">
              <div class="bg-gray-800/50 rounded-lg p-4">
                <div class="text-yellow-400 font-semibold mb-2">
                  {{ $t('cases.observability.stack.performanceThresholds.warning') }}
                </div>
                <ul class="text-gray-500 text-sm space-y-1">
              ...
              <div class="bg-gray-800/50 rounded-lg p-4">
                <div class="text-red-400 font-semibold mb-2">
                  {{ $t('cases.observability.stack.performanceThresholds.critical') }}
                </div>
                <ul class="text-gray-500 text-sm space-y-1">
...
│                                                             │
│   ┌─────────────┐  ┌─────────────┐  ┌─────────────┐        │
│   │ {{ $t('cases.observability.architecture.orchestrator') }}│  │  {{
              $t('cases.observability.architecture.aiEngine')
            }}  │  │{{ $t('cases.observability.architecture.memoryEngine') }}│        │
│   │  {{ $t('cases.observability.architecture.metricsLabel') }}    │  │  {{
              $t('cases.observability.architecture.metricsLabel')
            }}    │  │  {{ $t('cases.observability.architecture.metricsLabel') }}    │        │
│   └──────┬──────┘  └──────┬──────┘  └──────┬──────┘        │
│          │                │                │                │
        ...
        <div class="space-y-4">
          <div class="bg-gray-900/30 border border-gray-800 rounded-xl p-6">
            <h3 class="font-semibold text-white mb-2">
              {{ $t('cases.observability.decisions.ownershipQ') }}
            </h3>
          ...
          <div class="bg-gray-900/30 border border-gray-800 rounded-xl p-6">
            <h3 class="font-semibold text-white mb-2">
              {{ $t('cases.observability.decisions.tracesQ') }}
            </h3>
            <p class="text-gray-400 text-sm">
          ...
          <div class="bg-gray-900/30 border border-gray-800 rounded-xl p-6">
            <h3 class="font-semibold text-white mb-2">
              {{ $t('cases.observability.decisions.snapshotQ') }}
            </h3>
            <p class="text-gray-400 text-sm">
          ...
          <div class="bg-gray-900/30 border border-gray-800 rounded-xl p-6">
            <h3 class="font-semibold text-white mb-2">
              {{ $t('cases.observability.decisions.sampleRateQ') }}
            </h3>
            <p class="text-gray-400 text-sm">
  ...
  meta: [
    {
      name: 'description',
      content:
        'Complete observability system with business metrics, distributed tracing, token cost monitoring, AI decision telemetry and real-time alerts.',
    },
  ],
})
</script>
